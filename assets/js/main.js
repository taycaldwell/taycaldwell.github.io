...
// --------------------------------------------------
  ...
  function fn_siteBgParallaxStar() {
    ...
    $siteBgEffect.append(
	  ...
	  '<div class="parallax-star parallax-star-04"></div>' +
      '<div class="parallax-star parallax-star-05"></div>'
    );
	...
	function fn_parallaxStar_04() {
      $('.parallax-star-04').velocity({
        translateZ: 0,
        translateY: [ -2000, 0 ]
      }, {
        queue: false,
        ...
        duration: 70000,
        easing: 'linear',
        complete: fn_parallaxStar_04
      });
    }
    fn_parallaxStar_04();
	
	function fn_parallaxStar_05() {
      $('.parallax-star-05').velocity({
        translateZ: 0,
        translateY: [ -2000, 0 ]
      }, {
        queue: false,
